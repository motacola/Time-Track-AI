              ...
              <div className="flex flex-col justify-center space-y-4">
                ...
                <div className="space-y-4 text-muted-foreground">
                  ...
                  <p>
                    ...
                    {
                      "We're proud to help creative teams focus on what they do best—creating amazing work for their clients—while we handle the time tracking and project management."
                    }
                  </p>
                </div>
              </div>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              ...
              <Card className="bg-background">
                <CardContent className="pt-6">
                  ...
                  <p className="text-muted-foreground">
                    {
                      "We're constantly pushing the boundaries of what's possible with timesheet and project management software."
                    }
                  </p>
                </CardContent>
              </Card>
